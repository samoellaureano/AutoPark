...
def buscaRetanguloPlaca(source):
    ...
    while (video.isOpened()):
        ...
        # limite horizontal
        cv2.line(frame, (0, 300), (1280, 300), (0, 0, 255), 1)
        # limite vertical 1
        cv2.line(frame, (500, 0), (500, 720), (0, 0, 255), 1)
        # limite vertical 2
        cv2.line(frame, (1200, 0), (1200, 720), (0, 0, 255), 1)
